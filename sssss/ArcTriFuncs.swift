...
class ARCCOS:UniaryFunction{
    ...
    override func d()->Function?{
        return Cons(a:0)-var1!.d()/(Cons(a:1)-var1*var1)^Cons(a:0.5);
    }
}
...
class ARCCOT:UniaryFunction{
    ...
    override func d()->Function?{
        return Cons(a:0)-var1!.d()/(Cons(a:1)+var1*var1);
    }
}
class ARCSEC:UniaryFunction{
    ...
    override func d()->Function?{
        return var1!.d()/(var1*var1*(Cons(a:1)-var1^Cons(a:-2))^Cons(a:0.5));
    }
}
class ARCCSC:UniaryFunction{
    ...
    override func d()->Function?{
        return Cons(a:0)-var1!.d()/(var1*var1*(Cons(a:1)-var1^Cons(a:-2))^Cons(a:0.5));
    }
}